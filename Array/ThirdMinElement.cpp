...
int main(){
    ...
    cout<<"First Min Element is:- "<<firstMaxElement(arr,n)<<endl;
    cout<<"Second Min Element is:- "<<secondMaxElement(arr,n)<<endl;
    cout<<"Third Min Element is:- "<<thirdMaxElement(arr,n)<<endl;
